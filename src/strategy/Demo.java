    ...
    public static void main(String[] args) throws IOException {
        while (!order.isClosed()) {
            ...
            if (strategy == null) {
                ...
                // Клиент создает различные стратегии на основании
                // пользовательских данных, конфигураций и прочих параметров
            ...
            // Объект заказа делегирует сбор платежных данных стратегии,
            // так как только стратегии знают какие данные им нужны для примемы оплаты
            order.processOrder(strategy);
            System.out.println("Pay " + order.getTotalCost() + " units or Continue shopping? P/C: ");
            String proceed = reader.readLine();
            if (proceed.equalsIgnoreCase("P")) {
                // Стратегия запускает прием платежа
